            ...
            <tbody>
                {animal.map((animal) => (
                    <tr key={animal.id}>
                        ...
                        <td>
                            <button class="Btn-update" onClick={() => updateAnimal(animal)}>Change Name 
                                <svg class="svg-update" viewBox="0 0 512 512">
                            ...
                            <button class="button-delete" onClick={() => onDelete(animal.id)}>
